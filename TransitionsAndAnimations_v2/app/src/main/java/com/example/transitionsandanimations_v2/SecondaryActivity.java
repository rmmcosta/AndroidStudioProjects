...
public class SecondaryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActivityTransition(ivDroid, this.getBaseContext(), this, MainActivity.class, getString(R.string.droid_animation_name), ivCircle, getString(R.string.circle_animation_name));
    }
}