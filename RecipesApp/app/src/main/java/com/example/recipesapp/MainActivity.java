...
public class MainActivity extends AppCompatActivity implements RecipeItemClickListener {
    ...
    private void addEmpadaoRecipe() {
        Recipe empadao = new Recipe(R.drawable.empadao_bacalhau, "Empadão de bacalhau", "Puré de batata a envolver bacalhau desfiado com azeite e cebola numa camada de couve coração");
    ...
    private void addAssadoRecipe() {
        Recipe assado = new Recipe(R.drawable.assado, "Assado", "Vitela assada com batatinhas");
        assado.addIngredient(500, Unit.g, "Vitela");
        assado.addIngredient(10, Unit.unit, "Batata");
        assado.addIngredient(1, Unit.unit, "Cebola");
        assado.addIngredient(50, Unit.ml, "Vinho branco");
        recipes.add(assado);
    }

    private void addBacalhauRecipe() {
        Recipe bacalhau = new Recipe(R.drawable.empadao_bacalhau, "Bacalhau com natas", "Empadão de bacalhau com natas e um pouco de noz moscada");
